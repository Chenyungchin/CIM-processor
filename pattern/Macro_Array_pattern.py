...
def write_pattern(pattern_num):
    with open('./Macro_Array_pattern/command.dat', 'w+') as f_command:
        with open('./Macro_Array_pattern/STD_A.dat', 'w+') as f_std_a:
            with open('./Macro_Array_pattern/weight_in.dat', 'w+') as f_weight_in:
                with open('./Macro_Array_pattern/act_in1.dat', 'w+') as f_act_in1:
                    with open('./Macro_Array_pattern/act_in2.dat', 'w+') as f_act_in2:
                        with open('./Macro_Array_pattern/act_in3.dat', 'w+') as f_act_in3:
                            with open('./Macro_Array_pattern/weight_out.dat', 'w+') as f_weight_out:
                                with open('./Macro_Array_pattern/PSUM.dat', 'w+') as f_PSUM_out:
